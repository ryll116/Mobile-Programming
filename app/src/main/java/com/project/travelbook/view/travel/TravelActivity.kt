package com.project.travelbook.view.travel
...
import com.project.travelbook.BuildConfig
import com.project.travelbook.R
import com.project.travelbook.utils.BitmapManager.bitmapToBase64
import com.project.travelbook.viewmodel.TravelViewModel
...
class TravelActivity : AppCompatActivity() {
            ...
            .addOnSuccessListener(this) { location ->
                ...
                if (location != null) {
                    ...
                    Toast.makeText(this@TravelActivity,
                        "Failed to load GPS. Please check your GPS or internet connection!",
    ...
    private fun setInitLayout() {
        ...
        travelViewModel = ViewModelProvider(this, (ViewModelProvider.AndroidViewModelFactory
                .getInstance(this.application) as ViewModelProvider.Factory)).get(TravelViewModel::class.java)

        inputTanggal.setOnClickListener {
            val tanggal = Calendar.getInstance()
            val date =
                OnDateSetListener { _: DatePicker, year: Int, monthOfYear: Int, dayOfMonth: Int ->
                    tanggal[Calendar.YEAR] = year
                    tanggal[Calendar.MONTH] = monthOfYear
                    tanggal[Calendar.DAY_OF_MONTH] = dayOfMonth
                    val strFormatDefault = "dd MMMM yyyy HH:mm"
                    val simpleDateFormat = SimpleDateFormat(strFormatDefault, Locale.getDefault())
                    inputTanggal.setText(simpleDateFormat.format(tanggal.time))
                }
            DatePickerDialog(
                this@TravelActivity, date,
                tanggal[Calendar.YEAR],
                tanggal[Calendar.MONTH],
                tanggal[Calendar.DAY_OF_MONTH]
            ).show()
        }

        layoutImage.setOnClickListener {
            Dexter.withContext(this@TravelActivity)
                .withPermissions(
                    ...
                    override fun onPermissionsChecked(report: MultiplePermissionsReport) {
                        if (report.areAllPermissionsGranted()) {
                            try {
                                ...
                                cameraIntent.putExtra("camera_facing", "front")
                                ...
                                Toast.makeText(this@TravelActivity,
                                    "Failed to load camera", Toast.LENGTH_SHORT).show()
                            }
                        }
                    }
        ...
        btnAbsen.setOnClickListener {
            ...
            if (strFilePath.equals(null) || strNama.isEmpty() || strCurrentLocation.isEmpty()
                ...
                travelViewModel.addDataAbsen(
                    ...
                    strKeterangan)
                Toast.makeText(this@TravelActivity,
                    "Memory added to 'My Journey'", Toast.LENGTH_SHORT).show()
                finish()
            }
        }
    }
    ...
    private fun convertImage(imageFilePath: String?) {
        ...
        if (imageFile.exists()) {
            ...
            if (bitmapImage == null) {
                Toast.makeText(this@TravelActivity,
                    "Photo required!", Toast.LENGTH_LONG).show()
            } else {
